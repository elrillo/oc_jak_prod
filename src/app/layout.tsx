          ...
          <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-10 px-8 py-14">
            ...
            <div className="min-w-[280px] flex-1">
              ...
              <div className="flex gap-3 mb-5">
                {[
                  ...
                  { href: "https://www.tiktok.com/@observatorio_congreso", icon: "M12.525.02c1.31-.02 2.61-.01 3.91-.04.15 1.53.89 2.92 2.06 3.93 1.05.9 2.41 1.34 3.79 1.34v3.45c-1.74-.02-3.41-.57-4.83-1.55v7.24c0 1.23-.27 2.45-.79 3.56a8.204 8.204 0 01-5.07 4.28c-1.12.31-2.31.34-3.45.09-2.02-.45-3.8-1.71-4.88-3.46C2.26 17.2 1.83 15.22 2.2 13.24c.31-1.63 1.15-3.13 2.4-4.25 1.28-1.14 2.96-1.77 4.7-1.77 0 1.15.02 2.3.01 3.45-.63.02-1.25.18-1.8.48-.96.53-1.66 1.46-1.87 2.54-.18.88.01 1.81.52 2.54.51.72 1.3 1.21 2.18 1.35.89.15 1.81-.05 2.54-.56.9-.62 1.45-1.66 1.45-2.75V.02z" },
            ...
            <div className="min-w-[200px]">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a
                  href="https://observatoriocongreso.cl/jak/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground text-sm hover:text-white hover:translate-x-1 transition-all duration-300"
                >
